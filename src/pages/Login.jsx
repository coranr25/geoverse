    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', margin: 0 }}>Bienvenido de nuevo</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: 0 }}>
              ¿No tienes cuenta?{' '}
              <Link to="/register" style={{ color: 'var(--secondary)', fontWeight: '700', textDecoration: 'none' }}>
                Regístrate gratis
              </Link>
            </p>
          </div>
