      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            ...
            className="bg-gray-900 hover:bg-gray-800 p-6 rounded-xl cursor-pointer transition-colors"
          >
            <h2 className="text-xl font-semibold mb-2">🏳️ Banderas</h2>
            <p className="text-gray-400 text-sm">Adivina el país por su bandera</p>
          </div>

          <div className="bg-gray-900 p-6 rounded-xl opacity-40 cursor-not-allowed">
